...
export HUBOT_PROTONET_HOST=#{ENV['APP_INSTALLER_HUBOT_PROTONET_HOST']}
export HUBOT_PROTONET_PORT=#{ENV['APP_INSTALLER_HUBOT_PROTONET_PORT']}
export HUBOT_PROTONET_VERSION=#{ENV['APP_INSTALLER_HUBOT_PROTONET_VERSION']}
    EOS
